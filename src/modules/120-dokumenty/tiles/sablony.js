...
export default async function render(root) {
  try {
    setBreadcrumb(document.getElementById('crumb'), [
      ...
      { icon: 'article', label: 'Šablony' }
    ]);
  } catch (e) { /* ignore */ }

  root.innerHTML = `
    <div class="p-6 bg-white rounded-lg shadow">
      <h2 class="text-2xl font-bold mb-4 text-slate-800">Šablony dokumentů</h2>
      <p class="text-slate-600 mb-6">Správa šablon smluv a dopisů.</p>
